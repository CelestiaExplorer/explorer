...
export default {
  ...
  data() {
    return {
      erc20: '0x3C8421C3e471491F88d9c225d24C079D38304871',
      selectedAddress: 'cosmos1n9qg9e023p5xlaffg802wsyywa2uy9q8nxjm3q',
    }
  },
  computed: {
    chains() {
      const { data } = addressDecode('cosmos1n9qg9e023p5xlaffg802wsyywa2uy9q8nxjm3q')
