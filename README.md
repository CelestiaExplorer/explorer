...
```sh
./docker.sh
docker run -d -p 8080:8080 chainnode/tiaexplorer
```

# Enable API for TiaExplorer (do this on the config for your chain)
...
```
3. config your blockchain in [./src/chains](./src/chains)
